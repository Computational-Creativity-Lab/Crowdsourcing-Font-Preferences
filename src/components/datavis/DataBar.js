      ...
      <AnimatePresence>
        {isShown && (
          <motion.div
            ...
            class="z-10 text-white origin-bottom absolute"
          >
            <div class="translate-y-[-105%] translate-x-[-1rem] bg-zinc-900 rounded-xl p-4 overflow-hidden w-[300px] h-[324px] drop-shadow-2xl">
