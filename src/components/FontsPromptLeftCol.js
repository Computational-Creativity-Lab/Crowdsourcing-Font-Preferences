...
export default function FontsPromptLeftCol(props) {
  return (
    <div className="grid grid-template-rows-2 px-[40px] py-[40px]">
      <div>
        <h2 className="text-2xl lg:text-4xl pb-3 md:pb-5">
          {" "}
          Choose a font that feels...
        </h2>
        <h1 className="text-5xl lg:text-[5em] inline-block border-solid border-2 border-black rounded-full pt-[12px] pr-[34px] pb-[14px] pl-[32px]">
          {props.keyword}
        </h1>
      </div>
      <div className="justify-items-center justify-end flex flex-col">
        <h3 className="text-[28px] lg:text-4xl pb-4 ">
